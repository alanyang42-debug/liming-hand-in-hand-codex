  ...
  return <main data-lang={lang}>
    ...
    <section className="hero">
      ...
      <div className="hero-copy reveal">
        ...
        <h1>{t("手牽手")}<br/><span className="hero-love-line"><em>{t("讓愛無限")}</em><span className="linked-hearts" role="img" aria-label="愛心"><Image src="/media/brand/plain-red-heart.png" alt="" width={256} height={256} unoptimized/></span></span></h1>
        <p>{t(content.intro)}</p>
